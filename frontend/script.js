...
const MODELS = [
  ...
  },
  {
    ...
    label:'Alzheimer\'s',
    code:'NEURO-07',
    desc:'Alzheimer\'s diagnosis risk from cognitive, lifestyle, and clinical history.',
    source:'alzheimers_disease_data.csv',
    fields:[
      {id:'alz_age', column:'Age', label:'Age', unit:'years', type:'number', placeholder:'73', sample:73},
      {id:'alz_gender', column:'Gender', label:'Gender', type:'select', options:[['0','Male'],['1','Female']], sample:'0'},
      {id:'alz_ethnicity', column:'Ethnicity', label:'Ethnicity', type:'select', options:[['0','Group 0'],['1','Group 1'],['2','Group 2'],['3','Group 3']], sample:'0'},
      {id:'alz_education', column:'EducationLevel', label:'Education Level', type:'select', options:[['0','None'],['1','High School'],['2','Bachelor\'s'],['3','Higher']], sample:'2'},
      {id:'alz_bmi', column:'BMI', label:'BMI', unit:'kg/m²', type:'number', placeholder:'22.9', step:'0.1', sample:22.9},
      {id:'alz_smoking', column:'Smoking', label:'Smoking', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_alcohol', column:'AlcoholConsumption', label:'Alcohol Consumption', unit:'units/wk', type:'number', placeholder:'13.3', step:'0.1', sample:13.3},
      {id:'alz_physical_activity', column:'PhysicalActivity', label:'Physical Activity', unit:'hrs/wk', type:'number', placeholder:'6.3', step:'0.1', sample:6.3},
      {id:'alz_diet_quality', column:'DietQuality', label:'Diet Quality', unit:'0–10', type:'number', placeholder:'1.3', step:'0.1', sample:1.3},
      {id:'alz_sleep_quality', column:'SleepQuality', label:'Sleep Quality', unit:'4–10', type:'number', placeholder:'9.0', step:'0.1', sample:9.0},
      {id:'alz_family_history', column:'FamilyHistoryAlzheimers', label:'Family History of Alzheimer\'s', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_cvd', column:'CardiovascularDisease', label:'Cardiovascular Disease', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_diabetes', column:'Diabetes', label:'Diabetes', type:'select', options:[['1','Yes'],['0','No']], sample:'1'},
      {id:'alz_depression', column:'Depression', label:'Depression', type:'select', options:[['1','Yes'],['0','No']], sample:'1'},
      {id:'alz_head_injury', column:'HeadInjury', label:'Head Injury', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_hypertension', column:'Hypertension', label:'Hypertension', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_systolic_bp', column:'SystolicBP', label:'Systolic BP', unit:'mmHg', type:'number', placeholder:'142', sample:142},
      {id:'alz_diastolic_bp', column:'DiastolicBP', label:'Diastolic BP', unit:'mmHg', type:'number', placeholder:'72', sample:72},
      {id:'alz_chol_total', column:'CholesterolTotal', label:'Total Cholesterol', unit:'mg/dL', type:'number', placeholder:'242.4', step:'0.1', sample:242.4},
      {id:'alz_chol_ldl', column:'CholesterolLDL', label:'LDL Cholesterol', unit:'mg/dL', type:'number', placeholder:'56.2', step:'0.1', sample:56.2},
      {id:'alz_chol_hdl', column:'CholesterolHDL', label:'HDL Cholesterol', unit:'mg/dL', type:'number', placeholder:'33.7', step:'0.1', sample:33.7},
      {id:'alz_triglycerides', column:'CholesterolTriglycerides', label:'Triglycerides', unit:'mg/dL', type:'number', placeholder:'162.2', step:'0.1', sample:162.2},
      {id:'alz_mmse', column:'MMSE', label:'MMSE Score', unit:'0–30', type:'number', placeholder:'21.5', step:'0.1', sample:21.5},
      {id:'alz_functional', column:'FunctionalAssessment', label:'Functional Assessment', unit:'0–10', type:'number', placeholder:'6.5', step:'0.1', sample:6.5},
      {id:'alz_memory_complaints', column:'MemoryComplaints', label:'Memory Complaints', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_behavioral_problems', column:'BehavioralProblems', label:'Behavioral Problems', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_adl', column:'ADL', label:'ADL Score', unit:'0–10', type:'number', placeholder:'1.7', step:'0.1', sample:1.7},
      {id:'alz_confusion', column:'Confusion', label:'Confusion', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_disorientation', column:'Disorientation', label:'Disorientation', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_personality_changes', column:'PersonalityChanges', label:'Personality Changes', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
      {id:'alz_difficulty_tasks', column:'DifficultyCompletingTasks', label:'Difficulty Completing Tasks', type:'select', options:[['1','Yes'],['0','No']], sample:'1'},
      {id:'alz_forgetfulness', column:'Forgetfulness', label:'Forgetfulness', type:'select', options:[['1','Yes'],['0','No']], sample:'0'},
    ],
  },
  {
    id:'chronic_kidney',
    label:'Chronic Kidney (CKD)',
    code:'RENAL-08',
    desc:'Chronic kidney disease screen from a compact urinalysis and blood chemistry panel.',
    source:'chronic_kidney_disease-CKD.csv',
    fields:[
      {id:'ckd_bp', column:'Bp', label:'Blood Pressure', unit:'mmHg', type:'number', placeholder:'80', sample:80},
      {id:'ckd_sg', column:'Sg', label:'Specific Gravity (Urine)', type:'number', placeholder:'1.02', step:'0.001', sample:1.02},
      {id:'ckd_al', column:'Al', label:'Albumin (Urine)', unit:'0–5', type:'number', placeholder:'1', sample:1},
      {id:'ckd_su', column:'Su', label:'Sugar (Urine)', unit:'0–5', type:'number', placeholder:'0', sample:0},
      {id:'ckd_rbc', column:'Rbc', label:'RBC (Urine)', type:'select', options:[['1','Normal'],['0','Abnormal']], sample:'1'},
      {id:'ckd_bu', column:'Bu', label:'Blood Urea', unit:'mg/dL', type:'number', placeholder:'36', sample:36},
      {id:'ckd_sc', column:'Sc', label:'Serum Creatinine', unit:'mg/dL', type:'number', placeholder:'1.2', step:'0.1', sample:1.2},
      {id:'ckd_sod', column:'Sod', label:'Sodium', unit:'mEq/L', type:'number', placeholder:'137.5', step:'0.1', sample:137.5},
      {id:'ckd_pot', column:'Pot', label:'Potassium', unit:'mEq/L', type:'number', placeholder:'4.63', step:'0.01', sample:4.63},
      {id:'ckd_hemo', column:'Hemo', label:'Hemoglobin', unit:'g/dL', type:'number', placeholder:'15.4', step:'0.1', sample:15.4},
      {id:'ckd_wbcc', column:'Wbcc', label:'WBC Count', unit:'cells/cumm', type:'number', placeholder:'7800', sample:7800},
      {id:'ckd_rbcc', column:'Rbcc', label:'RBC Count', unit:'M/cumm', type:'number', placeholder:'5.2', step:'0.1', sample:5.2},
      {id:'ckd_htn', column:'Htn', label:'Hypertension', type:'select', options:[['1','Yes'],['0','No']], sample:'1'},
    ],
  },
  {
    id:'hypertension',
    label:'Hypertension',
    code:'CARD-09',
    desc:'Hypertension risk from lifestyle, family history, and clinical markers.',
    source:'hypertension_dataset.csv',
    fields:[
      {id:'ht_age', column:'Age', label:'Age', unit:'years', type:'number', placeholder:'69', sample:69},
      {id:'ht_salt_intake', column:'Salt_Intake', label:'Salt Intake', unit:'g/day', type:'number', placeholder:'8.0', step:'0.1', sample:8.0},
      {id:'ht_stress_score', column:'Stress_Score', label:'Stress Score', unit:'0–10', type:'number', placeholder:'9', sample:9},
      {id:'ht_bp_history', column:'BP_History', label:'BP History', type:'select', options:[['Normal','Normal'],['Prehypertension','Prehypertension'],['Hypertension','Hypertension']], sample:'Normal'},
      {id:'ht_sleep_duration', column:'Sleep_Duration', label:'Sleep Duration', unit:'hrs', type:'number', placeholder:'6.4', step:'0.1', sample:6.4},
      {id:'ht_bmi', column:'BMI', label:'BMI', unit:'kg/m²', type:'number', placeholder:'25.8', step:'0.1', sample:25.8},
      {id:'ht_medication', column:'Medication', label:'Medication', type:'select', options:[['ACE Inhibitor','ACE Inhibitor'],['Beta Blocker','Beta Blocker'],['Diuretic','Diuretic'],['Other','Other'],['None','None / Not specified']], sample:'None'},
      {id:'ht_family_history', column:'Family_History', label:'Family History', type:'select', options:[['Yes','Yes'],['No','No']], sample:'Yes'},
      {id:'ht_exercise_level', column:'Exercise_Level', label:'Exercise Level', type:'select', options:[['Low','Low'],['Moderate','Moderate'],['High','High']], sample:'Low'},
      {id:'ht_smoking_status', column:'Smoking_Status', label:'Smoking Status', type:'select', options:[['Non-Smoker','Non-Smoker'],['Smoker','Smoker']], sample:'Non-Smoker'},
    ],
  },
];
